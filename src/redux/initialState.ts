...
import {
  dateToString,
  randomDateBetweenXMonthAndYMonthAgo,
  randomDateSinceXMonthAgo,
} from "../utils";
  ...
  transactions: [
    {
      ...
      type: 1,
      amount: 69.99,
      date: randomDateBetweenXMonthAndYMonthAgo(3, 2),
    },
    {
    ...
    },
    {
      ...
      description: "Salary",
      amount: 800,
      date: randomDateBetweenXMonthAndYMonthAgo(2, 1),
    },
    {
    ...
    },
    {
      ...
      type: 1,
      amount: 102.99,
      date: randomDateSinceXMonthAgo(1),
    },
    {
    ...
    },
    {
      ...
      description: "Lidl",
      amount: 56.32,
      date: randomDateBetweenXMonthAndYMonthAgo(5, 4),
    },
    {
      ...
      description: "Lidl",
      amount: 85.99,
      date: randomDateBetweenXMonthAndYMonthAgo(4, 3),
    },
    {
    ...
    {
      id: "99337643-ff39-4b5d-96be-9ffd7ef1423f",
      type: 1,
      category: "ff8c7256-b3ea-42ea-b092-7218c3a1cddb",
      description: "Rewe",
      amount: 33.43,
    ...
    {
      id: "50d43172-571a-4385-904d-234ecd917b6d",
      type: 1,
      category: "30c38c18-ce5d-49f1-b5e2-15752613214b",
    ...
    {
      id: "11749c7d-9147-4dc1-b3fa-489b1241408c",
      type: 1,
      category: "e32c3003-dadf-4450-910a-151fb7e4bd6c",
      description: "Fitness",
      amount: 25,
    ...
    {
      id: "0eeaa850-4b47-4dcb-89d5-a490d83f2693",
      type: 1,
      category: "ff8c7256-b3ea-42ea-b092-7218c3a1cddb",
      description: "REWE",
      amount: 62.75,
    ...
    {
      id: "53b63874-d19a-4900-8623-334d94961220",
      type: 1,
      category: "b183cd0c-b5e6-46dc-844b-f49171d0d708",
      description: "Zara",
      amount: 150.56,
      date: randomDateBetweenXMonthAndYMonthAgo(5, 4),
    },
    {
      id: "5ffffe55-958c-4079-b705-c17b6df04f5a",
      type: 1,
      category: "adef755b-7a3b-41ef-806e-dee157245c6b",
      description: "Christmas Present",
      amount: 100,
      date: randomDateBetweenXMonthAndYMonthAgo(4, 3),
    },
    {
      id: "75c7c189-031c-4762-b0f4-feab4ffe1af1",
      type: 0,
      category: "48299da5-b1eb-4fd1-82d1-d58e9f3c71ed",
      description: "Salary",
      amount: 700,
    ...
    {
      id: "c596665a-3baf-497f-80a3-37965ae71251",
      type: 0,
      category: "48299da5-b1eb-4fd1-82d1-d58e9f3c71ed",
      description: "Salary",
      amount: 800,
      date: randomDateBetweenXMonthAndYMonthAgo(6, 5),
    },
    {
      id: "6fb97231-a749-4c4a-b006-dd3f1d104b8e",
      type: 1,
      category: "1e671ae1-429c-4e7f-b4a9-7fad95202bd0",
      description: "Bookshelf",
      amount: 79.99,
      date: randomDateBetweenXMonthAndYMonthAgo(6, 5),
    },
    {
      id: "0e798b6d-1ca3-4893-8e55-fb5a80dedb4f",
      type: 1,
      category: "ff8c7256-b3ea-42ea-b092-7218c3a1cddb",
      description: "REWE",
      amount: 150,
